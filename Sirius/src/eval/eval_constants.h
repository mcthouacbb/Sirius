...
constexpr PackedScore MATERIAL[6] = {S(  61,  131), S( 285,  432), S( 306,  444), S( 384,  788), S( 742, 1621), S(0, 0)};

constexpr PackedScore PSQT[6][64] = {
    {
        S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0),
        S(  54,   79), S(  36,   89), S(  20,  101), S(  55,   76), S(  72,   62), S(  57,   75), S(  45,   95), S(  68,   77),
    ...
    {
        S( -69,  -98), S( -74,  -27), S( -30,  -17), S(  -5,  -10), S( -32,    1), S( -58,    3), S(-100,    2), S( -84,  -59),
        S( -17,  -15), S(  12,    0), S(  23,   -3), S(  -3,    8), S(   2,   11), S(   5,    9), S(   0,   11), S( -11,   -2),
        S(   3,   -8), S( -10,    7), S(  29,   -3), S(  18,   16), S(   7,   22), S(  15,   12), S(   7,    2), S(  -5,   -2),
        S(  26,    4), S(  22,   16), S(  35,   18), S(  20,   25), S(  21,   26), S(  28,   13), S(  21,    2), S(  13,    7),
        S(  10,   16), S(  14,   16), S(  20,   19), S(  19,   27), S(  21,   20), S(  20,   17), S(  23,   -1), S(  10,    1),
        S(  15,   -1), S(  17,    4), S(  18,    3), S(  17,   15), S(   7,   16), S(   5,   -1), S(   8,   -7), S(  -5,   -8),
        S(  10,   -1), S(  12,   -5), S(  10,   -5), S(  14,    0), S(   9,   -1), S(  -1,   -3), S(  -1,   -8), S( -13,   -8),
        S(  -2,  -17), S(  -4,  -11), S(   4,  -10), S(   8,    2), S(   1,   -3), S( -14,  -10), S(  -7,  -16), S( -40,   -8),
    },
    {
        S( -47,  -13), S( -28,    6), S(  -8,   -3), S( -71,    9), S( -63,   15), S( -57,    4), S( -31,    7), S( -32,    5),
        S( -22,  -10), S( -45,    5), S( -13,    3), S( -10,    2), S( -23,   10), S(   1,   -1), S( -14,   -5), S(  -3,   -8),
        S(  10,   12), S(  -3,    8), S(  21,    6), S(   5,   12), S(  16,    5), S(   1,    0), S(   9,    5), S(   6,    1),
        S( -11,    6), S(   2,   13), S(   2,   17), S(  18,   19), S(  23,   23), S(  19,    8), S(   6,   11), S(  -4,    1),
        S(  16,   -6), S(  -3,   13), S(   8,   12), S(  15,   15), S(  21,   12), S(   6,   13), S(   4,    4), S(   5,   -2),
    ...
    {
        S(  13,   10), S( -18,   33), S( -14,   27), S( -20,   22), S( -13,   23), S( -17,   30), S(   4,   18), S(   8,   17),
        S(  23,    2), S(  30,    6), S(  10,   17), S(  -7,   20), S(  22,   13), S(  10,   23), S(   7,   19), S(   9,   11),
        S(  -7,    4), S(  20,    6), S(   3,    8), S(   6,    9), S(   5,    7), S(   0,   17), S(  15,   10), S(  -6,   13),
        S(  -9,    9), S( -14,   19), S(  -4,   15), S(  -6,   10), S(   0,    8), S(   7,   10), S(   6,    9), S(  -7,   12),
        S( -18,    5), S(   1,    9), S( -18,   15), S(  -5,    9), S(  -4,    3), S(  -9,    6), S( -10,    5), S(  -8,    2),
        S(   5,  -20), S(  23,  -23), S(   0,  -11), S(   0,  -13), S(  -3,  -12), S(  -6,  -13), S(  -4,  -15), S( -11,  -11),
        S(  -4,  -27), S(  28,  -35), S(   8,  -22), S(   4,  -19), S(   5,  -21), S(   3,  -19), S(  -6,  -18), S( -10,  -22),
        S(  -4,  -39), S(  -1,  -18), S(   4,  -18), S(  10,  -24), S(   8,  -25), S(   1,  -19), S(   1,  -23), S(  -1,  -21),
    },
    {
        S(  10,   -7), S(  55,  -33), S( -12,   38), S( -13,   24), S(  17,    3), S( -12,   20), S( -24,    8), S( -17,   12),
        S(  35,    6), S(   8,   17), S(  -8,   27), S( -32,   53), S(  -6,   33), S(  15,    1), S(  24,  -21), S(  19,   -9),
        S(   5,   10), S(  -1,   -1), S(  -7,   16), S( -14,   15), S(   9,   11), S(  21,    1), S(  20,  -19), S(  30,  -18),
        S(  -6,   17), S( -15,   33), S(  -9,   17), S( -15,   25), S(  -2,   23), S(  13,    2), S(  11,    4), S(   7,   -2),
        S(  -4,   14), S(  -2,   14), S( -13,   21), S(  -7,   28), S( -10,   34), S(  -2,   18), S(   6,   12), S(   3,    2),
        S(   2,  -11), S(   6,   -5), S(  -6,    9), S( -12,   16), S(  -8,   14), S(  -3,   13), S(  12,  -11), S(  10,  -19),
        S(   2,  -43), S(  11,  -60), S(   2,  -29), S(   1,  -14), S(   0,   -4), S(   3,  -17), S(   4,  -23), S(  10,  -39),
    ...
    },
    {
        ...
        S(  29,   15), S(  40,   52), S(  17,   29), S( -40,   50), S(  11,   -6), S(  11,   -6), S(  11,   -6), S(  11,   -6),
        S( -16,   19), S( -17,   54), S( -44,   30), S( -91,   46), S(  11,   -6), S(  11,   -6), S(  11,   -6), S(  11,   -6),
...
constexpr PackedScore MOBILITY[4][28] = {
    {S(  -3,  -29), S( -38,  -46), S( -17,  -16), S(  -9,    0), S(   1,    8), S(   6,   18), S(  13,   21), S(  20,   26), S(  30,   19), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0)},
    {S(  -9,  -45), S( -29,  -60), S( -17,  -32), S( -11,  -14), S(  -3,   -4), S(   2,    6), S(   3,   15), S(   6,   18), S(   6,   21), S(   8,   22), S(   9,   22), S(  13,   17), S(  10,   24), S(  15,    3), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0)},
    {S( -11,  -44), S( -29,  -69), S( -13,  -53), S(  -2,  -31), S(   1,  -17), S(  -1,   -6), S(   0,    1), S(   2,    7), S(   4,   11), S(   6,   17), S(   4,   27), S(   4,   33), S(   5,   38), S(   8,   39), S(  14,   36), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0)},
    {S(   1,    8), S( -31,  -71), S( -59, -112), S( -17, -199), S( -22,  -62), S( -14,  -10), S(  -4,  -23), S(  -2,   -4), S(  -1,   13), S(   1,   22), S(   4,   25), S(   7,   27), S(   8,   38), S(  11,   36), S(  11,   42), S(  13,   43), S(  14,   45), S(  16,   46), S(  15,   46), S(  21,   38), S(  25,   29), S(  32,   11), S(  28,   18), S(  35,   -7), S(  34,   -8), S(   2,    1), S( -15,   -9), S(-120,   13)}
};
...
constexpr PackedScore DOUBLED_PAWN[8] = {S(  -1,  -60), S(  14,  -37), S(   0,  -27), S(  -2,  -17), S(  -6,  -12), S(  -8,  -20), S(   5,  -37), S(   6,  -70)};
constexpr PackedScore BACKWARDS_PAWN[8] = {S(   0,    0), S(  -8,  -12), S(  -2,  -14), S(  -8,  -12), S(   1,  -18), S(  32,  -12), S(   0,    0), S(   0,    0)};
constexpr PackedScore PAWN_PHALANX[8] = {S(   0,    0), S(   6,   -4), S(  11,   -2), S(  19,    8), S(  38,   41), S( 117,  213), S(   4,  341), S(   0,    0)};
...
constexpr PackedScore CANDIDATE_PASSER[2][8] = {
    {S(   0,    0), S( -32,  -15), S( -18,   -8), S(   0,   25), S(  25,   52), S(  66,  113), S(   0,    0), S(   0,    0)},
    {S(   0,    0), S( -17,  -10), S(  -8,   13), S(  -4,   27), S(  18,   41), S(  28,  179), S(   0,    0), S(   0,    0)}
};

constexpr PackedScore PASSED_PAWN[2][2][8] = {
    {
        {S(   0,    0), S(   0,    0), S(   0,    0), S( -36,  -41), S( -17,   21), S(  10,  159), S(  69,  216), S(   0,    0)},
...
constexpr PackedScore PAWN_STORM[2][4][8] = {
    {
        ...
        {S(  32,    7), S(  46, -123), S(  93,  -81), S(  59,  -20), S(  16,   -2), S( -22,    8), S(   4,    6), S(   0,    0)},
    ...
    {
        {S(   0,    0), S(   0,    0), S(  61,   63), S( -21,   33), S( -25,   41), S( -16,   58), S(  -5,   45), S(   0,    0)},
...
constexpr PackedScore QUEENLESS_ATTACK = S(-144,  147);
...
constexpr PackedScore BISHOP_PAWNS[7] = {S(   3,   20), S(   4,   19), S(   3,   11), S(   0,    4), S(  -2,   -5), S(  -2,  -18), S(  -6,  -31)};

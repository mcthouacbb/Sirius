...
PawnStructure::PawnStructure(const Board& board)
{
    ...
    pawnDoubleAttacks[Color::WHITE] = attacks::pawnWestAttacks<Color::WHITE>(wpawns) & attacks::pawnEastAttacks<Color::WHITE>(wpawns);
    ...
    pawnDoubleAttacks[Color::BLACK] = attacks::pawnWestAttacks<Color::BLACK>(bpawns) & attacks::pawnEastAttacks<Color::BLACK>(bpawns);

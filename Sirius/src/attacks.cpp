...
constexpr uint64_t kingRingMagics[64] = {
    90080788774846464ULL,
    9241966978309033984ULL,
    4620983488787548240ULL,
    2311475260756902402ULL,
    9518358363411316773ULL,
    11534847294398595328ULL,
    3177290087742441476ULL,
    27166733710657664ULL,
    4684904698359056384ULL,
    2306978267963328512ULL,
    2306269624053795328ULL,
    1153134819006220320ULL,
    4899969720893079552ULL,
    1153240367340979200ULL,
    360307899108057104ULL,
    1153064509846323200ULL,
    288406323781976707ULL,
    12718183085942784000ULL,
    2308732564442972196ULL,
    9619772366947092736ULL,
    1441205207206838784ULL,
    1297063905902854403ULL,
    9224779970353190912ULL,
    18034190331150404ULL,
    2326110321016115200ULL,
    9466587307457974276ULL,
    282127811739780ULL,
    37506553665818632ULL,
    282102578807349ULL,
    4899951596273664000ULL,
    2324455623653064788ULL,
    19141398465873920ULL,
    144132917768159368ULL,
    2904823959285407744ULL,
    4629974281271377929ULL,
    1306062586185252897ULL,
    5769128989776414888ULL,
    4638901680150151808ULL,
    9838148577006714890ULL,
    4611730003191679012ULL,
    2251868537487360ULL,
    18665481201320448ULL,
    1955763454884184196ULL,
    9367489423987519488ULL,
    34376654856ULL,
    8214566822017499136ULL,
    4900197871704223744ULL,
    5276160ULL,
    288234774470983692ULL,
    297237575410656768ULL,
    576460891354038466ULL,
    2261147814266888ULL,
    95138544683057249ULL,
    3030929700877911040ULL,
    3760505697444823185ULL,
    9241396349256597673ULL,
    611478789234692ULL,
    9223653521495692416ULL,
    2251834374783064ULL,
    616422313051168ULL,
    4611862223772459036ULL,
    180152783337558024ULL,
    1199083402398565377ULL,
    1213861508170241ULL
};
...
constexpr uint32_t kingRingShifts[64] = {
     1,  0,  0,  0,  1,  2,  3,  2,
     0,  0,  1,  1,  0,  3,  0,  4,
     8,  2,  9,  7,  8,  8,  0,  9,
     6, 11,  7,  3,  6,  4,  8, 10,
...
{
    Bitboard kingRing = attackData.kingRings[kingSq.value()];
    Bitboard kingRingAttacks = kingRing & attacks;
    return
        (kingRingMagics[kingSq.value()] * (kingRingAttacks.value() >> kingRingShifts[kingSq.value()]))
            >> 56;
}
...
{
    return rays[sq.value()][static_cast<uint32_t>(dir)];
}
    ...
    for (uint32_t src = 0; src < 64; src++)
    {
        for (uint32_t dst = 0; dst < 64; dst++)
        {
            ...
            for (Direction dir : allDirs)
            {
                ...
                if ((srcRay & dstBB).any())
                {
                    Bitboard dstRay = getRay(Square(dst), oppDir(dir));

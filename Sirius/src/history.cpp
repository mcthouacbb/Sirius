...
int History::staticEvalCorrection(const Board& board, const SearchStack* stack, int ply) const
{
...
int History::correctStaticEval(int rawStaticEval, int correction) const
{
    int corrected = rawStaticEval + correction / CORR_HIST_SCALE;

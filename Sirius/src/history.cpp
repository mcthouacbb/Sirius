...
int History::correctStaticEval(int staticEval, const Board& board) const
{
    ...
    int corrected = staticEval + (132 * pawnEntry + 146 * materialEntry + 156 * nonPawnEntry + 116 * threatsEntry + 134 * minorPieceEntry + 128 * majorPieceEntry) / (128 * CORR_HIST_SCALE);

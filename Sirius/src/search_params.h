...
SEARCH_PARAM(ourThreatsCorrWeight, 287, 96, 768, 64);
SEARCH_PARAM(oppThreatsCorrWeight, 287, 96, 768, 64);
...
SEARCH_PARAM_CALLBACK(lmrBase, 79, -50, 200, 10, updateLmrTable);

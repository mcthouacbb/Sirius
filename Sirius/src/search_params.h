...
SEARCH_PARAM(histBonusLinear, 120, 64, 384, 32);
SEARCH_PARAM(histBonusOffset, 120, 64, 768, 64);

SEARCH_PARAM(maxHistMalus, 1896, 1024, 3072, 256);
SEARCH_PARAM(histMalusQuadratic, 4, 1, 8, 1);
SEARCH_PARAM(histMalusLinear, 120, 64, 384, 32);
SEARCH_PARAM(histMalusOffset, 120, 64, 768, 64);
...
SEARCH_PARAM(rfpImprovingMargin, 50, 30, 80, 8);
SEARCH_PARAM(rfpMargin, 80, 50, 100, 8);
SEARCH_PARAM(rfpHistDivisor, 400, 256, 512, 16);
...
SEARCH_PARAM(fpDepthMargin, 75, 10, 180, 12);

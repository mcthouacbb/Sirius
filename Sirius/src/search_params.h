...
SEARCH_PARAM(TKPNCorrWeight, 166, 96, 768, 64);
SEARCH_PARAM(TKPBCorrWeight, 166, 96, 768, 64);
SEARCH_PARAM(TKPRCorrWeight, 166, 96, 768, 64);
SEARCH_PARAM(TKPQCorrWeight, 166, 96, 768, 64);
SEARCH_PARAM(TKNBCorrWeight, 312, 96, 768, 64);
SEARCH_PARAM(TKNRCorrWeight, 166, 96, 768, 64);
SEARCH_PARAM(TKNQCorrWeight, 166, 96, 768, 64);
SEARCH_PARAM(TKBRCorrWeight, 166, 96, 768, 64);
SEARCH_PARAM(TKBQCorrWeight, 166, 96, 768, 64);
SEARCH_PARAM(TKRQCorrWeight, 368, 96, 768, 64);

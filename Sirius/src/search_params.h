...
SEARCH_PARAM(TKPNCorrWeight, 256, 96, 768, 64);
SEARCH_PARAM(TKPBCorrWeight, 224, 96, 768, 64);
SEARCH_PARAM(TKPRCorrWeight, 256, 96, 768, 64);
SEARCH_PARAM(TKPQCorrWeight, 256, 96, 768, 64);
SEARCH_PARAM(TKNBCorrWeight, 312, 96, 768, 64);
SEARCH_PARAM(TKNRCorrWeight, 224, 96, 768, 64);
SEARCH_PARAM(TKNQCorrWeight, 256, 96, 768, 64);
SEARCH_PARAM(TKBRCorrWeight, 224, 96, 768, 64);
SEARCH_PARAM(TKBQCorrWeight, 256, 96, 768, 64);

...
SEARCH_PARAM(TKPNCorrWeight, 128, 96, 768, 64);
SEARCH_PARAM(TKPBCorrWeight, 128, 96, 768, 64);
SEARCH_PARAM(TKPRCorrWeight, 128, 96, 768, 64);
SEARCH_PARAM(TKPQCorrWeight, 128, 96, 768, 64);
SEARCH_PARAM(TKNBCorrWeight, 281, 96, 768, 64);
SEARCH_PARAM(TKNRCorrWeight, 128, 96, 768, 64);
SEARCH_PARAM(TKNQCorrWeight, 128, 96, 768, 64);
SEARCH_PARAM(TKBRCorrWeight, 128, 96, 768, 64);
SEARCH_PARAM(TKBQCorrWeight, 128, 96, 768, 64);
SEARCH_PARAM(TKRQCorrWeight, 331, 96, 768, 64);

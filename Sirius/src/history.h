...
using LowPlyHist = MultiArray<HistoryEntry<HISTORY_MAX>, 4, 12, 64>;
...
private:
    ...
    int getLowPlyHist(Move move, Piece movingPiece, int ply) const;
    ...
    void updateLowPlyHist(Move move, Piece movingPiece, int ply, int bonus);

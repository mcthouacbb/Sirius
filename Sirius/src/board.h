...
public:
    ...
    Bitboard ourThreats() const;
    Bitboard oppThreats() const;
...
inline Bitboard Board::ourThreats() const
{
    return currState().threats[sideToMove()];
}

inline Bitboard Board::oppThreats() const
{
    return currState().threats[~sideToMove()];
}

...
// some impossible to capture en passant squares have been removed
...
void runBench(search::Search& search, i32 depth)
{
    ...
    f64 nps = static_cast<f64>(nodes)
        / std::chrono::duration_cast<std::chrono::duration<f64>>(t2 - t1).count();
